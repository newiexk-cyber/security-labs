...
![Kết quả chạy Unit Test Lab 1](./buoi1/images/lab1_unittest_result.png)
...
![Kết quả kiểm thử trên giao diện web Lab 1](./buoi1/images/lab1_web_test_result.png)
...
![Kết quả Git Hook chặn commit chứa secret](./buoi1/images/lab2_hook_blocked.png)
...
![Gửi Request kiểm thử qua Postman](./buoi1/images/lab3_postman_api.png)

#### b. Kết quả Response và kiểm tra tệp `secure.log`:

![Kết quả API và tệp log che giấu PII](./buoi1/images/lab3_response_and_log.png)
