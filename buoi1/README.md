...
- **Học viên thực hiện**: Nguyễn Nhật Lâm
- **Các bài thực hành trong Buổi 1**:
...
- **Kiểm thử trên Giao diện Web (`http://127.0.0.1:5000`)**:
  - `Email`: `nhatlam@gmail.com` $\rightarrow$ **Email hợp lệ** (Xanh)
...
---
*Hoàn thành trọn vẹn 3 bài thực hành trong Buổi 1 theo đúng giáo trình.*
